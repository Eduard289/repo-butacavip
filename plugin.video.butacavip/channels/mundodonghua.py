...
host = 'https://www.mundodonghua.org/'
...
def mainlist_animes(item):
    ...
    itemlist.append(item.clone( title = 'En emisión', action = 'list_all', url = host + 'lista-donghuas-emision', search_type = 'tvshow' ))
