...
# --- OPTIMIZACIÓN: Imports eliminados de aquí para evitar congelamientos ---
# Se han movido tmdb, GibberishAES y decrypters dentro de las funciones.
...
def play(item):
    ...
    # IMPORTACIÓN PEREZOSA: Las herramientas de desencriptación SOLO se cargan al reproducir
    try:
