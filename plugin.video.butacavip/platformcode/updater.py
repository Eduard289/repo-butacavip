...
# --- IDENTIDAD BUTACAVIP ---
__addon_name = 'ButacaVip'

# El ID se obtiene de la URL de ejecución (ej: plugin://plugin.video.butacavip/)
# Esto asegura que apunte a la carpeta correcta de userdata
...
def get_setting(name, channel="", server="", default=None):
    ...
    if value == "true":
        ...
        if name in ["adult_password", "adult_aux_intro_password", "adult_aux_new_password1", "adult_aux_new_password2"]:
            return value
        elif name.startswith('search_last_'): 
            return str(value)
